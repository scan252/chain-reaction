    ...
    return (
      <div className="fixed top-4 left-4 z-40">
        <motion.button
          ...
          className="px-3 py-2 rounded-lg bg-gradient-to-r from-blue-600/80 to-cyan-600/80 border border-blue-400/50 text-white text-sm font-bold shadow-lg shadow-blue-900/30 cursor-pointer"
        >
          📖 规则
        </motion.button>
              ...
              >
                ...
                <div className="text-white/80 text-sm leading-relaxed space-y-4">
                  <section>
                    ...
                    <p><span className="text-amber-400 font-semibold">执行槽位 (1-5)：</span>战场中央的 5 个空位。你打出的卡牌必须放置在这些槽位中。运气够好可以获得新的槽位哦~</p>
                  </section>
                  ...
                  <section>
                    ...
                    <ul className="space-y-2 ml-2">
                      ...
                      <li><span className="text-red-400">⚠️ 漏防惩罚：</span>如果受击槽位没有足够的护甲，剩余的伤害将直接扣除你的生命值！</li>
                    </ul>
                  </section>
                  ...
                  <section>
                    ...
                    <ol className="list-decimal list-inside space-y-1 ml-2">
                      <li>将卡牌拖入槽位（可随时调整位置，直到你满意）。</li>
                      <li>确认无误后，点击 <span className="text-orange-400 font-bold">【执行结算】</span>。</li>
                      <li>卡牌将从【槽位1】到【槽位5】从左至右依次触发。</li>
                      <li>你和敌人同时行动（哪怕你的伤害足以击杀你也会受到敌人的死前反扑）。</li>
                    </ol>
                  </section>
                </div>
              </motion.div>
  ...
  return (
    <div className="fixed top-4 left-4 z-40 flex flex-col gap-3">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={() => setShowRulesModal(true)}
        className="px-3 py-2 rounded-lg bg-gradient-to-r from-blue-600/80 to-cyan-600/80 border border-blue-400/50 text-white text-sm font-bold shadow-lg shadow-blue-900/30 cursor-pointer mt-2"
      >
        📖 规则
      </motion.button>
          ...
          >
            ...
            >
              ...
              <div className="text-white/80 text-sm leading-relaxed space-y-4">
                <section>
                  <h3 className="text-cyan-400 font-bold mb-2">第一步：认识战场</h3>
                  <p><span className="text-amber-400 font-semibold">执行槽位 (1-5)：</span>战场中央的 5 个空位。你打出的卡牌必须放置在这些槽位中。</p>
                </section>
