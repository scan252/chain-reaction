...
export function MapScreen() {
  ...
  // 获取runStore的addCardToMasterDeck方法（需要先在store中实现）
  ...
  return (
    ...
    >
        {/* 顶部信息 */}
        <div className="flex items-center justify-center gap-8 py-5 bg-black/40 border-b border-white/10 text-base">
        ...
        <div className="flex-1 flex justify-center items-start overflow-y-auto relative">
          {/* 吉祥物区域 - 放在地图左侧偏中间位置 */}
          <div className="absolute left-4 sm:left-8 md:left-16 top-1/2 -translate-y-1/2 z-10 flex flex-col items-center">
            <div 
            ...
            >
              {/* 吉祥物容器 */}
              <motion.div
                className="w-48 h-64 sm:w-56 sm:h-72 rounded-2xl flex items-center justify-center overflow-hidden"
                animate={{
            ...
            {showDialog && (
              ...
              >
                <div 
                  className={`relative bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-4 shadow-xl min-w-[320px] max-w-[400px] ${
                    isHiddenDialogue 
                ...
                >
                  {/* 对话框小三角 */}
                  <div 
                    className={`absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-white/95 rotate-45 ${
                      isHiddenDialogue 
                  ...
                  {/* 对话内容 */}
                  <p className="text-gray-800 font-medium leading-relaxed relative z-10" style={{ fontSize: '24px' }}>
                  ...
                  {showSecretQuestion && (
                    <div className="mt-5">
                      <p className="text-gray-800 font-medium mb-4" style={{ fontSize: '24px' }}>
                        那就请输入神秘指令吧：
                      </p>
          ...
          <svg width={canvasWidth} height={svgHeight} className="shrink-0">
          {/* 连线 */}
          {lines.map((line, i) => (
            <line
              key={i}
            ...
            >
              ...
              <div className="flex justify-center mb-6">
                ...
                >
                  ...
                  <h3 className="text-white font-bold text-xl text-center mb-2" style={{ fontSize: '24px' }}>
                    {FORBIDDEN_CARD.name}
                  </h3>
                  <p className="text-white/80 text-center text-sm" style={{ fontSize: '18px' }}>
